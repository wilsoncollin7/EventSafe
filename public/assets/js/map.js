...
const script = $('<script>').attr('src', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDwjr75wpVbrqdqfwE_Gb41DcE3T8s04wM&libraries=&v=weekly&map_ids=e9ec3bf73070e70b');
script.defer = true;
$('head').append(script);
